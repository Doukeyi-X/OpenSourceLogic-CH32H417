...
/*
 * Product strings: HS(USB2) and SS(USB3) must differ so host/OS can
 * tell which link stack actually enumerated the device.
 * "WCH CH32 LA USB2.0" / "WCH CH32 LA USB3.0"  (18 UTF-16 chars)
 */
/* USB2.0 High-Speed (USBHS path) */
const uint8_t MyProdInfo_HS[] =
{
    38, 0x03,
    'W', 0, 'C', 0, 'H', 0, ' ', 0,
    'C', 0, 'H', 0, '3', 0, '2', 0, ' ', 0,
    'L', 0, 'A', 0, ' ', 0,
    'U', 0, 'S', 0, 'B', 0, '2', 0, '.', 0, '0', 0,
};

/* USB3.0 SuperSpeed (USBSS path) */
const uint8_t MyProdInfo_SS[] =
{
    38, 0x03,
    'W', 0, 'C', 0, 'H', 0, ' ', 0,
    'C', 0, 'H', 0, '3', 0, '2', 0, ' ', 0,
    'L', 0, 'A', 0, ' ', 0,
    'U', 0, 'S', 0, 'B', 0, '3', 0, '.', 0, '0', 0,
};

/* Compat alias: default = HS product string */
