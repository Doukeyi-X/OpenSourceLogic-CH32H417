 ...
 * USB2.0 High-Speed (USBHS) : VID 1A86 / PID 0x5537
 * USB3.0 SuperSpeed (USBSS) : VID 1A86 / PID 0x5538  (= USB2 PID + 1)
 * IAP CDC uses 0x5539 (see IAP usb_desc.h)
 */
#define DEF_USB_VID                  0x1A86
#define DEF_USB_PID                  0x5537
#define DEF_USB30_PID                0x5538
...
/* USB2.0 (HS) product string length */
#define DEF_USBD_PROD_DESC_LEN       ((uint16_t)MyProdInfo_HS[ 0 ])
...
/* USB3.0 (SS) product string length */
#define DEF_USBSSD_PROD_DESC_LEN       ((uint16_t)MyProdInfo_SS[ 0 ])
...
extern const uint8_t MyProdInfo[ ];      /* compat alias of HS */
extern const uint8_t MyProdInfo_HS[ ];   /* USB2.0 High-Speed product */
extern const uint8_t MyProdInfo_SS[ ];   /* USB3.0 SuperSpeed product */
