...
void USBHS_Device_Endp_Init(void)
{
    ...
    USBHSD->UEP0_TX_CTRL = USBHS_UEP_T_RES_NAK; /*�˵�0���ͳ�ʼ��*/
    USBHSD->UEP0_RX_CTRL = USBHS_UEP_R_RES_ACK; /*�˵�0���ճ�ʼ��*/

    USBHSD->UEP1_RX_CTRL = USBHS_UEP_R_RES_ACK; /*�˵�1���ճ�ʼ��*/
    USBHSD->UEP2_RX_CTRL = USBHS_UEP_R_RES_ACK; /*�˵�2���ճ�ʼ��*/
    USBHSD->UEP3_RX_CTRL = USBHS_UEP_R_RES_ACK; /*�˵�3���ճ�ʼ��*/

    USBHSD->UEP1_TX_LEN = 0;
    USBHSD->UEP_TX_TOG_AUTO = USBHS_UEP1_T_EN;
    USBHSD->UEP_TX_BURST_MODE = USBHS_UEP1_T_EN; /*Э��������ݶ˵�*/
    USBHSD->UEP_TX_BURST = USBHS_UEP1_T_EN;
    USBHSD->UEP1_TX_CTRL = USBHS_UEP_T_RES_NAK; /*�˵�1��������NAK*/

    USBHSD->UEP2_TX_LEN = 0;
    USBHSD->UEP_TX_TOG_AUTO |= USBHS_UEP2_T_EN;
    USBHSD->UEP_TX_BURST_MODE |= USBHS_UEP2_T_EN; /*�߼������������ݶ˵�*/
    USBHSD->UEP_TX_BURST |= USBHS_UEP2_T_EN;
    USBHSD->UEP2_TX_CTRL = USBHS_UEP_T_RES_NAK; /*�˵�2��������NAK*/

    USBHSD->UEP3_TX_LEN = 0;
    USBHSD->UEP_TX_TOG_AUTO |= USBHS_UEP3_T_EN;
    USBHSD->UEP_TX_BURST_MODE |= USBHS_UEP3_T_EN; /*ADC���ݷ��Ͷ˵�*/
    USBHSD->UEP_TX_BURST |= USBHS_UEP3_T_EN;
    USBHSD->UEP3_TX_CTRL = USBHS_UEP_T_RES_NAK; /*�˵�3��������NAK*/
}
                    ...
                    else
                    {
                        ...
                        case USB_GET_DESCRIPTOR:
                            ...
                            case USB_DESCR_TYP_STRING:
                                ...
                                /* Descriptor 2, Product String descriptor (USB2.0 HS) */
                                case DEF_STRING_DESC_PROD:
                                    pUSBHS_Descr = MyProdInfo_HS;
